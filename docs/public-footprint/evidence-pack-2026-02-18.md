...
- Generated at (UTC): `2026-02-20T12:58:22Z`
...
| CI attestation gate enforced and passing | Workflow | 2026-02-20 | https://github.com/ogulcanaydogan/LLM-Supply-Chain-Attestation/actions/runs/22224988162 |
| Public-footprint snapshot workflow executed | Workflow | 2026-02-20 | https://github.com/ogulcanaydogan/LLM-Supply-Chain-Attestation/actions/runs/22216256815 |
| Tamper test suite executed (20 cases) | Benchmark/Security | 2026-02-20 | repository artifact path: `.llmsa/tamper/results.json` |
...
| Stars / forks / watchers | 0 / 0 / 0 | `.llmsa/public-footprint/20260220T125809Z/snapshot.json` |
| Release downloads (cumulative) | 324 | `.llmsa/public-footprint/20260220T125809Z/snapshot.json` |
| CI pass rate (last 30 days) | 92.22% (83/90) | `.llmsa/public-footprint/20260220T125809Z/ci-health.json` |
| CI pass rate (post-hardening window) | 98.33% (59/60) | `.llmsa/public-footprint/20260220T125809Z/ci-health.json` |
