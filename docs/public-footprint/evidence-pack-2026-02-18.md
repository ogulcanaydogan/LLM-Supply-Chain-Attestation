...
| Upstream contribution in review | External PR | 2026-03-06 | https://github.com/sigstore/cosign/pull/4740 |
...
3. Limitations:
   ...
   - 3 upstream PR(s) are closed-unmerged and count as non-converted evidence.
