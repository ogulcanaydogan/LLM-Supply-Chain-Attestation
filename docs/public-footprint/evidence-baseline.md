...
| Upstream external PRs | not yet tracked in this repo | `docs/public-footprint/external-contribution-log.md` |
| Third-party mentions | none linked yet | `docs/public-footprint/third-party-mention-plan.md` |
| Anonymous pilot case study | not published yet | `docs/public-footprint/case-study-template.md` |
