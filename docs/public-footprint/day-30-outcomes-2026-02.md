...
| CI pass-rate (rolling 30-day) | >=95% | 90.91% (70/77) | not met | `.llmsa/public-footprint/20260220T083257Z/ci-health.json` |
| CI pass-rate (post-hardening baseline) | >=95% | 100% (37/37) | achieved | `.llmsa/public-footprint/20260220T083257Z/ci-health.json` |
