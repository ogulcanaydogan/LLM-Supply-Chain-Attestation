...
| CI pass-rate (rolling 30-day) | >=95% | 92.22% (83/90) | not met | `.llmsa/public-footprint/20260220T125809Z/ci-health.json` |
| CI pass-rate (post-hardening baseline) | >=95% | 98.33% (59/60) | achieved | `.llmsa/public-footprint/20260220T125809Z/ci-health.json` |
