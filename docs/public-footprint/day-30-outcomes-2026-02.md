...
| CI pass-rate (rolling 30-day) | >=95% | 90% (63/70) | not met | `.llmsa/public-footprint/20260220T082139Z/ci-health.json` |
| CI pass-rate (post-hardening baseline) | >=95% | 100% (30/30) | achieved | `.llmsa/public-footprint/20260220T082139Z/ci-health.json` |
