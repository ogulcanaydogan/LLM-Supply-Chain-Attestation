...
| CI pass-rate (rolling 30-day) | >=95% | 90.59% (77/85) | not met | `.llmsa/public-footprint/20260220T101459Z/ci-health.json` |
| CI pass-rate (post-hardening baseline) | >=95% | 97.78% (44/45) | achieved | `.llmsa/public-footprint/20260220T101459Z/ci-health.json` |
