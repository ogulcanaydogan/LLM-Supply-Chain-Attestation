...
| CI pass-rate (rolling 30-day) | >=95% | 90.48% (76/84) | not met | `.llmsa/public-footprint/20260220T101115Z/ci-health.json` |
| CI pass-rate (post-hardening baseline) | >=95% | 97.73% (43/44) | achieved | `.llmsa/public-footprint/20260220T101115Z/ci-health.json` |
