...
| CI pass-rate (rolling 30-day) | >=95% | 91.11% (82/90) | not met | `.llmsa/public-footprint/20260220T103601Z/ci-health.json` |
| CI pass-rate (post-hardening baseline) | >=95% | 98% (49/50) | achieved | `.llmsa/public-footprint/20260220T103601Z/ci-health.json` |
