...
| GitHub stars | 0 | >=25 | 0 | `.llmsa/public-footprint/20260220T080440Z/snapshot.json` |
| GitHub forks | 0 | >=5 | 0 | `.llmsa/public-footprint/20260220T080440Z/snapshot.json` |
| GitHub watchers | 0 | >=5 | 0 | `.llmsa/public-footprint/20260220T080440Z/snapshot.json` |
| Release downloads (cumulative) | 184 | >=400 | 140 | `.llmsa/public-footprint/20260220T080440Z/snapshot.json` |
| CI pass rate (last 30 days) | 93.3% | >=95% | 89.06% | `.llmsa/public-footprint/20260220T080446Z/ci-health.json` |
| CI pass rate (post-hardening window) | n/a | >=95% | 100% | `.llmsa/public-footprint/20260220T080446Z/ci-health.json` |

## Current Snapshot (2026-02-20 UTC)

- Snapshot artifact (local): `.llmsa/public-footprint/20260220T080440Z/snapshot.json`
- CI health artifact (local): `.llmsa/public-footprint/20260220T080446Z/ci-health.json`
- CI pass rate source window: 57/64 successful runs (`89.06%`).
- CI pass rate post-hardening (`2026-02-19T16:08:22Z`): 24/24 successful runs (`100%`, meets target=`true`).
...
- Upstream PR review stage:
  ...
  - `closed`: 2
  - `merged`: 1
- Dashboard generated at: `2026-02-20T08:04:51Z`
