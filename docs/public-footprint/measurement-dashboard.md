...
| GitHub stars | 0 | >=25 | 0 | `.llmsa/public-footprint/20260223T200753Z/snapshot.json` |
| GitHub forks | 0 | >=5 | 0 | `.llmsa/public-footprint/20260223T200753Z/snapshot.json` |
| GitHub watchers | 0 | >=5 | 0 | `.llmsa/public-footprint/20260223T200753Z/snapshot.json` |
| Release downloads (cumulative) | 184 | >=400 | 140 | `.llmsa/public-footprint/20260223T200753Z/snapshot.json` |
| CI pass rate (last 30 days) | 93.3% | >=95% | 95.35% | `.llmsa/public-footprint/20260223T200801Z/ci-health.json` |
| CI pass rate (post-hardening window) | n/a | >=95% | 98.75% | `.llmsa/public-footprint/20260223T200801Z/ci-health.json` |

## Current Snapshot (2026-02-23 UTC)

- Snapshot artifact (local): `.llmsa/public-footprint/20260223T200753Z/snapshot.json`
- CI health artifact (local): `.llmsa/public-footprint/20260223T200801Z/ci-health.json`
- CI pass rate source window: 82/86 successful runs (`95.35%`).
- CI pass rate post-hardening (`2026-02-19T16:08:22Z`): 79/80 successful runs (`98.75%`, meets target=`true`).
...
- Upstream PR review stage:
  ...
  - `closed`: 2
  - `merged`: 1
- Dashboard generated at: `2026-02-23T20:08:07Z`
