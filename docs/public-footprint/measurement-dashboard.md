...
| GitHub stars | 0 | >=25 | 0 | `.llmsa/public-footprint/20260223T213304Z/snapshot.json` |
| GitHub forks | 0 | >=5 | 0 | `.llmsa/public-footprint/20260223T213304Z/snapshot.json` |
| GitHub watchers | 0 | >=5 | 0 | `.llmsa/public-footprint/20260223T213304Z/snapshot.json` |
| Release downloads (cumulative) | 184 | >=400 | 224 | `.llmsa/public-footprint/20260223T213304Z/snapshot.json` |
| CI pass rate (last 30 days) | 93.3% | >=95% | 97.65% | `.llmsa/public-footprint/20260223T213311Z/ci-health.json` |
| CI pass rate (post-hardening window) | n/a | >=95% | 98.78% | `.llmsa/public-footprint/20260223T213311Z/ci-health.json` |

## Current Snapshot (2026-02-23 UTC)

- Snapshot artifact (local): `.llmsa/public-footprint/20260223T213304Z/snapshot.json`
- CI health artifact (local): `.llmsa/public-footprint/20260223T213311Z/ci-health.json`
- CI pass rate source window: 83/85 successful runs (`97.65%`).
- CI pass rate post-hardening (`2026-02-19T16:08:22Z`): 81/82 successful runs (`98.78%`, meets target=`true`).
...
- Upstream PR review stage:
  ...
  - `closed`: 2
  - `merged`: 1
- Dashboard generated at: `2026-02-23T21:33:16Z`
