...
| GitHub stars | 0 | >=25 | 0 | `.llmsa/public-footprint/20260220T130125Z/snapshot.json` |
| GitHub forks | 0 | >=5 | 0 | `.llmsa/public-footprint/20260220T130125Z/snapshot.json` |
| GitHub watchers | 0 | >=5 | 0 | `.llmsa/public-footprint/20260220T130125Z/snapshot.json` |
| Release downloads (cumulative) | 184 | >=400 | 140 | `.llmsa/public-footprint/20260220T130125Z/snapshot.json` |
| CI pass rate (last 30 days) | 93.3% | >=95% | 92.22% | `.llmsa/public-footprint/20260220T130125Z/ci-health.json` |
| CI pass rate (post-hardening window) | n/a | >=95% | 98.36% | `.llmsa/public-footprint/20260220T130125Z/ci-health.json` |

## Current Snapshot (2026-02-20 UTC)

- Snapshot artifact (local): `.llmsa/public-footprint/20260220T130125Z/snapshot.json`
- CI health artifact (local): `.llmsa/public-footprint/20260220T130125Z/ci-health.json`
- CI pass rate source window: 83/90 successful runs (`92.22%`).
- CI pass rate post-hardening (`2026-02-19T16:08:22Z`): 60/61 successful runs (`98.36%`, meets target=`true`).
...
- Upstream PR review stage:
  ...
  - `closed`: 2
  - `merged`: 1
- Dashboard generated at: `2026-02-20T13:01:41Z`
