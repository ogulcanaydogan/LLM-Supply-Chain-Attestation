...
| GitHub stars | 0 | >=25 | 0 | `.llmsa/public-footprint/20260220T150025Z/snapshot.json` |
| GitHub forks | 0 | >=5 | 0 | `.llmsa/public-footprint/20260220T150025Z/snapshot.json` |
| GitHub watchers | 0 | >=5 | 0 | `.llmsa/public-footprint/20260220T150025Z/snapshot.json` |
| Release downloads (cumulative) | 184 | >=400 | 140 | `.llmsa/public-footprint/20260220T150025Z/snapshot.json` |
| CI pass rate (last 30 days) | 93.3% | >=95% | 93.33% | `.llmsa/public-footprint/20260220T150036Z/ci-health.json` |
| CI pass rate (post-hardening window) | n/a | >=95% | 98.51% | `.llmsa/public-footprint/20260220T150036Z/ci-health.json` |

## Current Snapshot (2026-02-20 UTC)

- Snapshot artifact (local): `.llmsa/public-footprint/20260220T150025Z/snapshot.json`
- CI health artifact (local): `.llmsa/public-footprint/20260220T150036Z/ci-health.json`
- CI pass rate source window: 84/90 successful runs (`93.33%`).
- CI pass rate post-hardening (`2026-02-19T16:08:22Z`): 66/67 successful runs (`98.51%`, meets target=`true`).
...
- Upstream PR review stage:
  ...
  - `closed`: 2
  - `merged`: 1
- Dashboard generated at: `2026-02-20T15:00:52Z`
