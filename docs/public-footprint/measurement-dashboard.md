...
| GitHub stars | 0 | >=25 | 0 | `.llmsa/public-footprint/20260223T153759Z/snapshot.json` |
| GitHub forks | 0 | >=5 | 0 | `.llmsa/public-footprint/20260223T153759Z/snapshot.json` |
| GitHub watchers | 0 | >=5 | 0 | `.llmsa/public-footprint/20260223T153759Z/snapshot.json` |
| Release downloads (cumulative) | 184 | >=400 | 140 | `.llmsa/public-footprint/20260223T153759Z/snapshot.json` |
| CI pass rate (last 30 days) | 93.3% | >=95% | 94.12% | `.llmsa/public-footprint/20260223T153809Z/ci-health.json` |
| CI pass rate (post-hardening window) | n/a | >=95% | 98.57% | `.llmsa/public-footprint/20260223T153809Z/ci-health.json` |

## Current Snapshot (2026-02-23 UTC)

- Snapshot artifact (local): `.llmsa/public-footprint/20260223T153759Z/snapshot.json`
- CI health artifact (local): `.llmsa/public-footprint/20260223T153809Z/ci-health.json`
- CI pass rate source window: 80/85 successful runs (`94.12%`).
- CI pass rate post-hardening (`2026-02-19T16:08:22Z`): 69/70 successful runs (`98.57%`, meets target=`true`).
...
- Upstream PR review stage:
  ...
  - `closed`: 2
  - `merged`: 1
- Dashboard generated at: `2026-02-23T15:38:17Z`
