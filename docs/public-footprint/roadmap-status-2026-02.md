...
| WS2: CI pass-rate | rolling `>=95%` | rolling `90.7% (78/86)`; post-hardening `97.83% (45/46)` | partially complete |
...
- Blockers:
  - Rolling 30-day CI pass rate is below target (`90.7%`, target `>=95%`).
