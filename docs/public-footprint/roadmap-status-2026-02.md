...
| WS2: CI pass-rate | rolling `>=95%` | rolling `90.59% (77/85)`; post-hardening `97.78% (44/45)` | partially complete |
...
- Blockers:
  - Rolling 30-day CI pass rate is below target (`90.59%`, target `>=95%`).
