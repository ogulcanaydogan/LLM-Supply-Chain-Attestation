...
| WS2: CI pass-rate | rolling `>=95%` | rolling `90.48% (76/84)`; post-hardening `97.73% (43/44)` | partially complete |
...
- Blockers:
  - Rolling 30-day CI pass rate is below target (`90.48%`, target `>=95%`).
