...
| WS2: CI pass-rate | rolling `>=95%` | rolling `91.01% (81/89)`; post-hardening `97.96% (48/49)` | partially complete |
...
- Blockers:
  - Rolling 30-day CI pass rate is below target (`91.01%`, target `>=95%`).
