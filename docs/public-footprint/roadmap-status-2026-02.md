...
| WS2: CI pass-rate | rolling `>=95%` | rolling `89.39% (59/66)`; post-hardening `100% (26/26)` | partially complete |
...
- Blockers:
  - Rolling 30-day CI pass rate is below target (`89.39%`, target `>=95%`).
