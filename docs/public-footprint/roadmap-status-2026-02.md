...
| WS2: CI pass-rate | rolling `>=95%` | rolling `90.12% (73/81)`; post-hardening `97.56% (40/41)` | partially complete |
...
- Blockers:
  - Rolling 30-day CI pass rate is below target (`90.12%`, target `>=95%`).
